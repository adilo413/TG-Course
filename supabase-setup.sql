...
CREATE POLICY "Only authenticated users can delete courses" ON courses
...
CREATE POLICY "Only authenticated users can insert tokens" ON tokens
    FOR INSERT WITH CHECK (true);

CREATE POLICY "Only authenticated users can update tokens" ON tokens
    FOR UPDATE USING (true);

CREATE POLICY "Only authenticated users can delete tokens" ON tokens
    FOR DELETE USING (true);
